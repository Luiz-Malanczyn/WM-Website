...
export const galleryImages: GalleryItem[] = [
  ...
  { id: 7, src: videoGaleria1, alt: 'Video 1', type: 'video' },
  { id: 8, src: videoGaleria2, alt: 'Video 2', type: 'video' },
  { id: 9, src: videoGaleria3, alt: 'Video 3', type: 'video' },
  { id: 10, src: videoGaleria4, alt: 'Video 4', type: 'video' },
  { id: 11, src: videoGaleria5, alt: 'Video 5', type: 'video' },
  { id: 12, src: videoGaleria6, alt: 'Video 6', type: 'video' },
]
